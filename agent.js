...
class Assistant {
    ...
    async init() {
        try {
            ...
            console.log(`Advanced AI Assistant v${this.version} initialized successfully`);
        } catch (error) {
    ...
    displayMessage(message) {
        try {
            ...
            const senderName = { user: 'You', assistant: 'Assistant', system: 'System', tool: 'Tool' }[message.role] || message.role;
    ...
    showWelcomeMessage() {
        ...
        if (conv && conv.messages.length === 0) {
            this.addMessage('assistant', 'Welcome How can I assist you?');
        }
    }
...
document.addEventListener('DOMContentLoaded', () => {
    window.agentFlow = new Assistant();
});
